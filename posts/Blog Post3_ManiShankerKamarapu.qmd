...
<!-- ```{r} -->
<!-- book_ASIN <- list("B0001DBI1Q", "B0001MC01Y", "B00026WUZU", "B07ZN4WM13", "B005C7QVUE", "B000BO2D64", "B000I2JFQU", "B000UW50LW", "B001FD6RLM", "B07HHJ7669", "B07T6BQV2L", "B07T43YYRY") -->
<!-- out <- scrape_amazon("B0001DBI1Q", 1) -->
<!-- for (j in book_ASIN) { -->
<!--   for (i in 1:400) { -->
<!--     out <- bind_rows(out, scrape_amazon(j, i)) -->
<!--     if((i %% 3) == 0){ -->
...
```{r}
reviews$clean_text <- clean(reviews$review_text)
reviews
```
...
```{r}
textplot_wordcloud(text)
```

## Further study

I will be adding more reviews and doing preprocessing and also plot some analysis plots and if possible also do some sentiment analysis.
