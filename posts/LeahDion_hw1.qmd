---
title: "Mapping Feminist Thought Using Computational Text Analysis"
author: "Leah Dion"
description: "Introduction to text-as-data research project."
date: "10/23/2022"
format:
  html:
    toc: true
...
It seems the entire published archive of each of these journals in the time periods above is available on JSTOR's Constellate project [here](https://about.jstor.org/whats-in-jstor/text-mining-support/). In my next post I'll download the relevant archives and attempt to read them into R Studio to see how much useful information they contain.
