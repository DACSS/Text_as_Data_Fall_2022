...
- I have some ideas about my own, however I am still not sure. 
- I think about getting data from twitter may be my best option, but I will sill be looking for the other options to use. I would also like to use APIs.
- Analyzing movie scripts and comparing regional wise and sentiments. 
- Fake news analysis in social media.
- I also thought of working on demographic and biological factors effecting students.
- Suicide rates based on countries and reasons.
- I am not sure if I will get the right data. So will try to conclude based on the data available and further more analysis.
