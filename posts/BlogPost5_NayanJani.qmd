...
stop_words1 = c("i", "me", "my", "myself", "we", "our", "ours", "ourselves", "you", "your", "yours","a","the","in","as","on", "is","it", "to","of","are","not","and","quot","don","youtu.be","an","have","this","if","they","v","2","their","can", "than")
...
The Topic Model implies that the major topic of discussion surrounds showing respect to both cultures (Western
and Middle East). The other topics in the model suggests discussions surrounding migrant workers and how they are treated.
...
#| warning: false
#| echo: false
differentKs <- searchK(smaller_dfm,
                       K = c(5, 25, 50),
                       N = 30,
                       data = full_df,
                       max.em.its = 1000,
